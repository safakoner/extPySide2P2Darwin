...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySide2P2Darwin/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySide2P2Darwin.packageEnvLib    @brief [ MODULE ] - Package environment module.
